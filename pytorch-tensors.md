...
# This becomes row major as K is the leading dimension
A_row = torch.ones((M, K))

# the tensor B shape is (K, N) and stride is (N, 1)
# this makes B, column-major
# This becomes row major where N is the leading dimension
...
# This becomes column major where M is the leading dimension
A_col = A_col.t()
...
# This becomes column major where K is the leading dimension
B_col = B_col.t()
```
